...
public class SequentialCommand extends SequentialCommandGroup {
  ...
  public SequentialCommand(DrivebaseSubsystem drivebaseSubsystem, ArmSubsystem armSubsystem) {
    ...
    addCommands(new TimedDrivebaseCommand(m_DrivebaseSubsystem, 0.1, 0.5), new UninvertMotors(m_DrivebaseSubsystem), 
    new TimedDrivebaseCommand(m_DrivebaseSubsystem, 0.25, 0.25), new WaitCommand(0.5), new InvertMotors(m_DrivebaseSubsystem) 
