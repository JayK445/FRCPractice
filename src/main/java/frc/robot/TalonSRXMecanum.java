 ...
 */
public class TalonSRXMecanum extends RobotDriveBase implements Sendable, AutoCloseable {
  private static int instances;

  private final TalonSRX m_frontLeftMotor;
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty(
        "Front Left Motor Speed", () -> m_frontLeftMotor.getActiveTrajectoryArbFeedFwd(), 
        value -> m_frontLeftMotor.set(ControlMode.PercentOutput, value));
    builder.addDoubleProperty(
        "Front Right Motor Speed",() -> m_frontRightMotor.getActiveTrajectoryArbFeedFwd(),
        value -> m_frontRightMotor.set(ControlMode.PercentOutput, value));
        builder.addDoubleProperty(
            "Rear Left Motor Speed",
            () -> m_rearLeftMotor.getActiveTrajectoryArbFeedFwd(),
            value -> m_rearLeftMotor.set(ControlMode.PercentOutput, value));
    builder.addDoubleProperty(
        "Rear Right Motor Speed",
        () -> m_rearRightMotor.getActiveTrajectoryArbFeedFwd(),
        value -> m_rearRightMotor.set(ControlMode.PercentOutput, value));
  }
}
